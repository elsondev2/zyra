...
const names = ['arrow-left','arrow-up','chevron-down','chevron-right','message-square','monitor','folder','settings','search','plus','x','check','qr-code','camera','link','wifi','wifi-off','circle-alert','refresh-cw','ellipsis','terminal','git-branch','palette','sun','moon','smartphone','archive','pencil','paperclip','square','arrow-down','bot','workflow','sliders-horizontal','info','shield-check','log-out','square-pen','copy','folder-open','filter','chevrons-up-down','circle','external-link','keyboard','file','clipboard-paste','mic','audio-lines','mic-off','volume-2','headphones','phone-off','play','chevron-left','puzzle'];
