...
class SVGParser
{
   ...
   // Zyra compatibility: parsers without this feature already have it disabled.
   static void disableDocDeclarations(XmlPullParser parser) throws XmlPullParserException
   {
      try {
         parser.setFeature(XmlPullParser.FEATURE_PROCESS_DOCDECL, false);
      } catch (XmlPullParserException unsupported) {
