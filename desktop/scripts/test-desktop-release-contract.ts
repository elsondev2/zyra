...
const desktopInstallIndex = releaseWorkflow.indexOf('- name: Install Desktop dependencies')
const sandboxSetupIndex = releaseWorkflow.indexOf('- name: Prepare Linux Electron sandbox helper and virtual display')
