...
const cases = [
    ...
    { oldPage: 'providers', section: 'Providers', label: 'Default Git AI provider', route: '/settings/workspace/source-control/writing' },
    { oldPage: 'providers', section: 'Zyra · ChatGPT', label: 'Commit model', route: '/settings/workspace/source-control/writing' },
    { oldPage: 'providers', section: 'Zyra · ChatGPT', label: 'Pull-request model', route: '/settings/workspace/source-control/writing' }
]
...
assert.deepEqual(resolveSettingsSearchLocation('providers', createSettingsSectionTargetId('Zyra · ChatGPT')), { pathname: '/settings/workspace/source-control/writing', targetId: createSettingsSectionTargetId('Text generation') })
...
assert.deepEqual(resolveSettingsSearchLocation('appearance', theme), { pathname: '/settings/app/appearance/typography', targetId: theme }, 'font links follow the typography view')
