...
app.whenReady().then(async () => {
    ...
    await owner.webContents.executeJavaScript(`BrowserRecording.startAssistantBrowserRecording({tabId:'tab:synthetic',guestWebContentsId:${view.webContents.id}},{width:640,height:480}).catch(e=>{throw new Error(e.name+': '+e.message)})`, true)
