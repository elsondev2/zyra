...
// Native geometry, entrance transitions and idle work are exercised in test-browser-slot-geometry.mjs.
...
assert.match(browserViewManagerSource, /captureBrowserPage\(page\)/, 'Browser snapshots come from the owned native page')
