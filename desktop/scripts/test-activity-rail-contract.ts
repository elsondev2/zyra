...
assert.equal(virtualTimelineSource.includes('maintainVisibleContentPosition={{ data: true }}'), true, 'database-page prepends and measured row sizes preserve the visible anchor')
