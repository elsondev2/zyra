    ...
    return (
        <SettingsPageContainer>
            ...
            <SettingsSection title="Output and history">
                ...
                <SettingsRow title="Live tool output" description="Choose whether running tool output opens automatically." control={<SettingsSegmented value={settings.assistantToolOutputDefaultMode} options={[{ value: 'expanded', label: 'Expanded' }, { value: 'minimized', label: 'Minimized' }]} onChange={(assistantToolOutputDefaultMode) => updateSettings({ assistantToolOutputDefaultMode })} label="Tool output mode" />} />
