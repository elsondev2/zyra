    ...
    return (
        <SettingsPageContainer>
            <SettingsSection title="File preview">
                ...
                <SettingsRow title="Fullscreen right panel" description="Keep the secondary information panel visible in fullscreen previews." control={<SettingsSwitch checked={settings.filePreviewFullscreenShowRightPanel} onCheckedChange={(filePreviewFullscreenShowRightPanel) => updateSettings({ filePreviewFullscreenShowRightPanel })} label="Show fullscreen right panel" />} />
