...
export function AssistantBrowserAdBlockPrompt({
    ...
    return (
        <AnchoredNativeOverlay><aside className="absolute bottom-4 left-1/2 z-[40] w-[min(360px,calc(100%-32px))] -translate-x-1/2 rounded-xl border border-[color-mix(in_srgb,var(--color-text)_13%,transparent)] bg-[color-mix(in_srgb,var(--color-card)_97%,var(--color-bg))] p-3 shadow-[0_18px_54px_rgba(0,0,0,0.38)]" role="dialog" aria-label="Turn on built-in ad blocking">
