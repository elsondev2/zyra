...
const syntaxTargets = [
  ...
  "scripts/test-idle-memory-scheduler.mjs",
  "scripts/test-model-provider-connections.mjs",
  "scripts/test-provider-transactions.mjs",
  "scripts/test-agent-role-models.mjs",
  "scripts/test-server-memory-queue.mjs",
...
const desktopTasks = [
  ...
  { label: "desktop:test:browser-recording", bunArgs: ["run", "--cwd", "desktop", "test:browser-recording"] },
  { label: "desktop:test:browser-recording-host", bunArgs: ["run", "--cwd", "desktop", "test:browser-recording-host"] },
  { label: "desktop:test:browser-recording-native", bunArgs: ["run", "--cwd", "desktop", "test:browser-recording-native"] },
