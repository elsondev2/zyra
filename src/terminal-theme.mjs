...
const localBuiltInThemes = [
  {
    ...
    colors: {
      ...
      toolDetailFg: "#908caa",
      toolHintFg: "#6e6a86",
      menuDescriptionFg: "#908caa",
      quoteFg: "#908caa",
      quoteBorderFg: "#c4a7e7",
    },
  },
  {
    name: "quiet",
    description: "Muted default. Low color, low glare.",
    source: "built-in",
    colors: {
      muted: 244,
      primary: 109,
...
export function buildTerminalTheme(themeInput = {}) {
  ...
  return {
    ...
    menuDescriptionFg: fg(pickColor(colors.menuDescriptionFg, colors.toolDetailFg, colors.toolHintFg, colors.muted, colors.userFg)),
    quoteFg: fg(pickColor(colors.quoteFg, colors.toolDetailFg, colors.userFg, colors.muted)),
    quoteBorderFg: fg(pickColor(colors.quoteBorderFg, colors.accent, colors.primary, colors.muted)),
...
function themeFromUiCatalog(theme) {
  ...
  return {
    ...
    colors: {
      ...
      menuDescriptionFg: tokens.textDarker ?? tokens.textSecondary,
      quoteFg: tokens.textDarker ?? tokens.textSecondary,
      quoteBorderFg: tokens.secondary ?? tokens.primary,
      toolCall: {
